...
public class ProjectController {
    ...
    @PreAuthorize("isAuthenticated()")
    @PatchMapping()
    public ResponseEntity<?> editProjectName(@Valid @RequestBody ProjectPatchDTO projectPatchDTO, @AuthenticationPrincipal WielloUser wielloUser) {
        try {
            projectService.editProjectName(projectPatchDTO, wielloUser);
